...
async def info(update: Update, context: CallbackContext) -> None:
    document_list = (
        "<b>Список документов:</b>\n\n"
        "<i>1.</i> <b>Пложение о Закупках;</b>\n"
        "<i>2.</i> <i>М.03.01.03.01</i> <b>Разработка стратегии закупки версия</b> <i>1.0;</i>\n"
        "<i>3.</i> <i>М.03.03.01.01.01</i> <b>Требования к порядку рассмотрения, оценки и сопоставления;</b>\n"
        "<i>4.</i> <i>М.03.05.02.02</i> <b>Работа с коммерческими предложениями версия</b> <i>1.0;</i>\n"
        "<i>5.</i> <i>СК.03.01.02</i> <b>Проведение Предквалификации потенциальных участников;</b>\n"
        "<i>6.</i> <i>СК.03.01.03</i> <b>Управление стратегиями закупок версия</b> <i>1.1;</i>\n"
        "<i>7.</i> <i>СК.03.01.05.01</i> <b>Управление эффективностью деятельности контрагента;</b>\n"
        "<i>8.</i> <i>СК.03.02.01</i> <b>Формирование Годового плана закупок версия</b> <i>3.1;</i>\n"
        "<i>9.</i> <i>СК.03.03.01.01</i> <b>Проведение конкурентного отбора версия</b> <i>3.0;</i>\n"
        "<i>10.</i> <i>СК.03.03.02.01</i> <b>Проведение закупки у единственного поставщика подрядчика;</b>\n"
        "<i>11.</i> <i>СК.03.03.02.02</i> <b>Проведение безальтернативной закупки версия</b> <i>2.1;</i>\n"
        "<i>12.</i> <i>СК.03.03.02.03</i> <b>Проведение закупок способом маркетинговые исследования;</b>\n"
        "<i>13.</i> <i>СК.03.05.02</i> <b>Формирование и рассмотрение заявок на закупку импортных;</b>\n"
        "<i>14.</i> <i>СК.03.07.01.02</i> <b>Управление исполнением договорных обязательств.</b>"
    )
